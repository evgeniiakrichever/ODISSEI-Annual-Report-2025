...
// Each workstream = one hard page, no images, auto-scaled by Puppeteer
function wsPage(ws) {
  return `
<div class="ws-page">
  <div class="ws-inner">
...
/* ── WORKSTREAM PAGES — fixed A4 box, Puppeteer scales inner content ── */
.ws-page {
  width: 210mm;
  height: 297mm;
  overflow: hidden;
...
<!-- WORKSTREAMS — auto-scaled by Puppeteer to fit one A4 page each -->
